...
client.init(api_key: apiKey, config: ConfigBuilder.new.logger(logger).config_url("https://config.ff.harness.io/api/1.0").event_url("https://events.ff.harness.io/api/1.0").build)
